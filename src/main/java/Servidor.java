...
public class Servidor{
    ...
    public static void main(String[] args) throws Exception {
        ...
        s.createContext("/professor", Servidor::produtor);     // publica e exclue atividades
        s.createContext("/aluno", Servidor::consumidor); // visualiza e envia atividades
